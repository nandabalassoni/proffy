...
function TeacherForm(){
    ...
    function setScheduleItemValue(position:number, field:string, value:string){   
        const updateScheduleItems = scheduleItems.map((scheduleItem, index) =>{  //o map sempre vai retornar o array com a mesma qntde de campos ali dentro
            if(index === position){
            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    <fieldset>
                        ...
                        <Input name="avatar" label="Avatar (aqui você pode usar o link de uma foto de uma rede social sua =D)" value={avatar} onChange={(e) => {setAvatar(e.target.value)}} />
